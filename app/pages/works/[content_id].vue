...
<template>
    <div ref="root" class="w-full px-4 pt-6 max-w-5xl mx-auto mb-20">
        ...
        <NuxtLink
            data-reveal="back"
            to="/"
            class="inline-flex items-center gap-1.5 text-xs font-mono text-gray-400 hover:text-rose-400 transition-colors mb-10"
        >
        ...
        <div class="grid md:grid-cols-2 gap-10 md:gap-16 items-start mb-16">
            ...
            <div class="flex flex-col justify-start pt-4 md:pt-8">
                ...
                <!-- wavy underline -->
                <svg data-reveal="info" viewBox="0 0 200 10" xmlns="http://www.w3.org/2000/svg" class="w-32 mb-8 text-rose-200">
                    <path d="M0,5 C25,10 50,0 75,5 C100,10 125,0 150,5 C175,10 187,3 200,5" fill="none" stroke="currentColor" stroke-width="1.5"/>
                </svg>

                <!-- description -->
                <div data-reveal="info" class="border-l-2 border-rose-200 pl-4 mb-8">
                ...
                <NuxtLink
                    ...
                    class="inline-flex items-center gap-2 text-xs font-mono text-rose-400 hover:text-rose-600 transition-colors"
                >
                    <span
                        class="px-3 py-1.5 border border-rose-200 hover:border-rose-400 transition-colors truncate max-w-xs"
        ...
        <template v-if="galleryImages.length > 0">
            ...
            <div data-reveal="gallery-head">
                ...
                <svg viewBox="0 0 200 10" xmlns="http://www.w3.org/2000/svg" class="w-24 mx-auto mb-8 text-rose-200">
                    <path d="M0,5 C25,10 50,0 75,5 C100,10 125,0 150,5 C175,10 187,3 200,5" fill="none" stroke="currentColor" stroke-width="1.5"/>
                </svg>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 items-start">
                <div
                    ...
                    :key="img.url"
                    data-gallery
                    class="relative aspect-square overflow-hidden border border-gray-100"
                    :style="{
                ...
                >
                    ...
                    />
                    <!-- reveal curtain -->
                    <div data-curtain aria-hidden="true" class="absolute inset-0 bg-rose-200" style="transform: scaleY(0)"></div>
                </div>
            </div>
        </template>
