...
<template>
    <div class="min-h-screen bg-white flex flex-col items-center justify-center px-4 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center max-w-md">
            ...
            <h1 class="text-8xl md:text-9xl font-black text-neutral-800 leading-none mb-2">
                {{ error?.statusCode ?? 404 }}
            </h1>

            <!-- wavy underline -->
            <svg viewBox="0 0 200 10" xmlns="http://www.w3.org/2000/svg" class="w-40 mx-auto mb-8 text-rose-200">
                <path d="M0,5 C25,10 50,0 75,5 C100,10 125,0 150,5 C175,10 187,3 200,5" fill="none" stroke="currentColor" stroke-width="1.5"/>
            </svg>

            <p class="text-sm font-mono text-gray-500 mb-10">
            ...
            >
                <span
                    class="px-5 py-2.5 border border-rose-200 hover:border-rose-400 transition-colors"
